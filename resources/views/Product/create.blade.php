                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                          ...
                          <!--  <h6 class="font-weight-bold pt-4 pb-1">Ad Type:</h6>
                            ...
                            <textarea name="short" id="" class="border p-3 w-100" rows="3" placeholder="Short"></textarea>
                            <h6 class="font-weight-bold pt-4 pb-1">Long description:</h6>
                            <textarea name="long" id="" class="border p-3 w-100" rows="7" placeholder="Long description of product"></textarea>
                        </div>
                        <div class="col-lg-6">
