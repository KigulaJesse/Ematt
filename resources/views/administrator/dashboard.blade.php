            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <a href="/home" target="_blank" class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light">View Website</a>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                        <div class="white-box analytics-info">
                            ...
                            <ul class="list-inline two-part">
                                ...
                                <li class="text-right"><i class="ti-arrow-up text-purple"></i> <span class="counter text-purple">{{count($users)}}</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 col-xs-12">
                ...
                <!--<div class="row">
                    <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                        <div class="white-box">
                            ...
                            <div id="ct-visits" style="height: 200px;"></div>
                        </div>
                    </div>
                </div>-->
                <!-- ============================================================== -->
